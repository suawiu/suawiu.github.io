...
<div class="text-slate-600 dark:text-slate-400 text-sm mt-1">Appear as a host and student interviewer in SK hynix's official YouTube educational series, "Future Talent CLASS," conducting expert interviews on next-generation semiconductor technologies, including HBM with Prof. Changhwan Shin (Korea University) <a href="https://youtu.be/TM0HTpKgzA8?si=mIa_eW7eXhdZ_x_P" target="_blank" rel="noopener noreferrer" aria-label="Future Talent CLASS EP.1 HBM YouTube" class="yt-link inline-flex items-center align-middle transition-colors"><svg xmlns="http://www.w3.org/2000/svg" class="ml-1 h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.2a3 3 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A3 3 0 0 0 .5 6.2 31.7 31.7 0 0 0 0 12a31.7 31.7 0 0 0 .5 5.8 3 3 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a3 3 0 0 0 2.1-2.1A31.7 31.7 0 0 0 24 12a31.7 31.7 0 0 0-.5-5.8ZM9.6 15.7V8.3L16 12l-6.4 3.7Z"/></svg></a>, and PIM with Prof. Se-Bum Paik (KAIST), while translating advanced technical concepts into accessible educational content for students and the general public.</div>
