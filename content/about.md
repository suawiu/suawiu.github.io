...
<div class="space-y-16 max-w-4xl mx-auto py-8">

<!-- 1. Education -->
<section>
<h2 class="flex items-center text-2xl font-bold text-cyan-600 dark:text-cyan-400 mb-6 border-b border-slate-200 dark:border-slate-800 pb-2">
...
<div class="text-slate-700 dark:text-slate-300">Seoul, South Korea</div>
<div class="text-slate-600 dark:text-slate-400 text-sm mt-1">Dept. of Physics</div>
</div>
</li>
</ul>
</section>
...
<div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all group">
...
<p class="text-slate-600 dark:text-slate-400 text-xs leading-relaxed">Superconducting Qubits, Circuit QED, Quantum Error Correction</p>
</div>
<div class="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all group">
...
<ul class="space-y-4">
<li class="flex items-start group">
<span class="mr-4 mt-2 h-2 rounded-full bg-amber-400 w-2 shrink-0 group-hover:scale-125 transition-transform"></span>
<div>
