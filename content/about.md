...
<div class="space-y-20 max-w-4xl mx-auto py-8">
  ...
  <section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
        ...
        <div class="p-6 rounded-2xl bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all group">
            ...
            <p class="text-slate-600 dark:text-slate-400 text-sm">Low-temperature Systems</p>
        </div>
        <div class="p-6 rounded-2xl bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-cyan-500 dark:hover:border-cyan-500 transition-all group">
            <h3 class="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2 group-hover:text-cyan-600 dark:group-hover:text-cyan-400">Data Analysis</h3>
            <p class="text-slate-600 dark:text-slate-400 text-sm">Financial Time Series Analysis, Statistical Modeling</p>
        </div>
    </div>
  </section>
  ...
  <section>
        ...
        <ul class="space-y-4">
            ...
            <li class="flex items-start">
                <span class="mr-2 mt-1.5 h-2 w-2 rounded-full bg-cyan-500 shrink-0"></span>
                <div>
                    <strong class="text-slate-900 dark:text-slate-100">Computer Literacy Level 2</strong>
                    <span class="text-slate-500 text-sm block">2025</span>
                </div>
            </li>
            <li class="flex items-start">
        ...
        <ul class="space-y-4">
            <li class="flex items-start">
               <span class="mr-2 mt-1.5 h-2 w-2 rounded-full bg-amber-400 shrink-0"></span>
                <div>
                    <strong class="text-slate-900 dark:text-slate-100">KC Scholarship Foundation</strong>
            ...
            <li class="flex items-start">
               <span class="mr-2 mt-1.5 h-2 w-2 rounded-full bg-amber-400 shrink-0"></span>
                <div>
                    <strong class="text-slate-900 dark:text-slate-100">5th Place</strong>
  ...
  <section>
    ...
    <div class="relative border-l-2 border-slate-200 dark:border-slate-800 ml-4 space-y-8">
      
      <div class="ml-10 relative">
         <span class="absolute -left-[45px] top-1.5 h-6 w-6 rounded-full border-4 border-cyan-500 dark:border-cyan-400 bg-white dark:bg-slate-900"></span>
